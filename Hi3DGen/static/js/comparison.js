...
$('#comparisonSelectionPanel .selectable-image').each((i, img) => {
    img.src = `https://hi3dgen-release.tos-cn-beijing.volces.com/project_pages/static/comparison/${img.getAttribute('name')}_color.png`;
})
...
comparisonSelectionPanel.addEventListener('click', function(event) {
    ...
    const meshPath1 = `https://hi3dgen-release.tos-cn-beijing.volces.com/project_pages/static/comparison/ours_wo_texture_resize/${name}.glb`, meshPath2 = `https://hi3dgen-release.tos-cn-beijing.volces.com/project_pages/static/comparison/${baseline}_wo_texture_resize/${name}.glb`;
    const texturePath = `https://hi3dgen-release.tos-cn-beijing.volces.com/project_pages/static/comparison/${name}_color.png`;
...
document.getElementById('comparisonBaselineSelection').addEventListener('change', function (event) {
    ...
    const meshPath2 = `https://hi3dgen-release.tos-cn-beijing.volces.com/project_pages/static/comparison/${baseline}_wo_texture_resize/${name}.glb`;
    const texturePath = `https://hi3dgen-release.tos-cn-beijing.volces.com/project_pages/static/comparison/${name}_color.png`;
